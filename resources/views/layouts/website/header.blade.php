                    ...
                    <ul class="nav">
                        ...
                        @else <!---------- = registered user (any user type in the system) ---------->
                            <li class="submenu">
                                ...
                                <a class="username" href="javascript:void(0);"><img style="border-radius: 5px;" width="40" class="username" src="{{auth()->user()->avatar}}" alt="{{auth()->user()->username ?? auth()->user()->name}}"></a>
                                <ul>
